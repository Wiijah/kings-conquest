...
echo genLightbox("New Map", "new_map", "<table class='form_table'>
    <tr><th class='lightbox_left'>Map Name: <span class='required'>*</span><span class='form_subtext'><br />3 - 20 characters.</span></th><td><input type='text' class='text auto_off' id='map_name' placeholder='Map Name' autocomplete='off' /></td></tr>
    </table>
    <div class='btn lightbox_btn' id='lightbox_btn_new_map'>Submit</div>");
