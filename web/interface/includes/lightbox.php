...
echo genLightbox("Create Game", "create_game", "<table class='form_table'>
    ...
    <tr><th>Room Password:<span class='form_subtext'><br />Optional. Up to 20 characters.</span></th><td><input type='password' class='text' id='room_pass' placeholder='Leave blank if no password.' /></td></tr>
    </table>
